...
class PyytError(Exception):
    """Base pyyt exception that all others inherit.
...
class MaxRetriesExceeded(PyytError):
    """Maximum number of retries exceeded."""


class HTMLParseError(PyytError):
    """HTML could not be parsed"""


class ExtractError(PyytError):
...
class VideoUnavailable(PyytError):
