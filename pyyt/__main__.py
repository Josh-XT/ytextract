"""
This module implements the core developer interface for pyyt.

The problem domain of the :class:`YouTube <YouTube> class focuses almost
exclusively on the developer interface. pyyt offloads the heavy lifting to
...
import pyyt
import pyyt.exceptions as exceptions
from pyyt import extract, request
from pyyt import Stream, StreamQuery
from pyyt.helpers import install_proxy
from pyyt.innertube import InnerTube, _default_clients
from pyyt.metadata import YouTubeMetadata
from pyyt.monostate import Monostate
...
class YouTube:
    ...
    def __init__(
        ...
        :param func on_complete_callback:
            ...
            complete events.
        :param dict proxies:
            (Optional) A dict mapping protocol to proxy address which will be used by pyyt.
