...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="pyyt - Download YouTube videos and captions",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  pyyt https://youtube.com/watch?v=VIDEO_ID          Download a video
  pyyt --captions https://youtube.com/watch?v=ID     Download captions only
  pyyt --file videos.txt                             Download videos from a file
  pyyt --channels channel1 channel2                  Download from channels
        """,
    )
